    ...
    <div class="container" data-aos="fade-up">
        <?php if(isset($_GET['action'])){ ?>
            <?php 
                ...
                $rows = $sql->fetch();
                $sql_th = $conn->query("SELECT * FROM contact_us_th");
                $rows_th = $sql_th->fetch();
                                ...
                                <div class="col-lg-4">
                                    <div class="info">
                                        <div class="address">
                                            <i class="bi bi-geo-alt"></i>
                                            <h4>สถานที่:</h4>
                                            <p><?php echo $rows_th['address_contact_th']; ?></p>
                                        </div>
                                        <div class="open-hours">
                                            <i class="bi bi-clock"></i>
                                            <h4>เวลา:</h4>
                                            <p><?php echo $rows_th['detail_op_th']; ?></p>
                                        </div>
                                        <div class="email">
                                            <i class="bi bi-envelope"></i>
                                            <h4>อีเมลล์:</h4>
                                            <p><?php echo $rows_th['email_th']; ?></p>
                                        </div>
                                        <div class="phone">
                                            <i class="bi bi-phone"></i>
                                            <h4>เบอร์โทรติดต่อ:</h4>
                                            <p><?php echo $rows_th['phone_th']; ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-8 mt-5 mt-lg-0">
